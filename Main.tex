...
\include{content/0Preamble}
\include{content/1Introduction}
\include{content/2Preliminaries}
\include{content/3Colorization}
\include{content/4SketchSimplification}
% Tobias says he would like me to focus on two areas only
% \include{content/5SuperResolution}
% \include{content/6FrameInterpolation}
\include{content/7FutureDirections}
\include{content/8Conclusions}
\include{content/9Appendices}
